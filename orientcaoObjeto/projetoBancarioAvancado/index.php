...
use efetuacoes\Transferencia;      //puxando a classe das transacoes

$name = 'Joao Victor';      //definindo o cliente
$cpf = '000.000.000-00';    //o cpf do cliente
$address = 'Rua Anonima 325';   //o endereco do cliente

$cliente1 = new Banco(new Corrente(), new Poupanca(), new Transferencia(new Corrente(), new Poupanca()));    
//colocando as tres classes dentro da classe principal
...
$cliente1->transfCorrente(200);     //transferindo para conta corrente
